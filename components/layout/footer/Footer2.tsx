					...
					<div className="container position-relative z-1 border-top border-1 pb-2 pt-4">
						<div className="text-center">
							<a className="d-flex main-logo align-items-center justify-content-center mb-3">
								...
								<span className="fs-4 ms-2">Will.dev</span>
							</a>
							<div className="d-flex justify-content-center gap-3">
								{/* <a href="http://facebook.com">
									<i className="ri-facebook-circle-fill fs-18" />
								</a> */}
								<a href="https://x.com/ParwarWilliamO">
									<i className="ri-twitter-x-fill fs-18" />
								</a>
								<a href="https://www.linkedin.com/in/parwar-ofosu-william-a66786203/">
									<i className="ri-linkedin-fill fs-18" />
								</a>
								<a href="https://github.com/1253William">
