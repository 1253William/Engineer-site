									...
									<div className="row g-4">
										...
										<div className="col-lg-4 col-md-6">
											<div className="card-servies-2 rounded-2 h-100 hover-up">
												...
												<p className="fs-7 text-300 fw-regular">Creating and integrating <span className="text-secondary-2">GraphQL & RESTful APIs</span> to enable smooth communication between front-end and back-end systems.</p>
											</div>
										</div>
										<div className="col-lg-4 col-md-6">
											<div className="card-servies-2 rounded-2 h-100 hover-up">
												...
												<p className="fs-7 text-300 fw-regular">Designing and managing databases with SQL and NoSQL technologies such as <span className="text-secondary-2">MySQL</span>, <span className="text-secondary-2">PostgreSQL/Supabase</span>, and <span className="text-secondary-2">MongoDB</span>.</p>
											</div>
										</div>
										<div className="col-lg-4 col-md-6">
											<div className="card-servies-2 rounded-2 h-100 hover-up">
												...
												<h6 className="my-3 fw-medium">Serverless Architecture</h6>
												<p className="fs-7 text-300 fw-regular">Optimizing cost & performance with cloud functions, <span className="text-secondary-2">cloud providers and containerization</span> for seamless deployments.</p>
											</div>
										</div>
										<div className="col-lg-4 col-md-6">
											<div className="card-servies-2 rounded-2 h-100 hover-up">
												...
												<p className="fs-7 text-300 fw-regular">Improving the speed and performance of web applications to provide a better user experience.</p>
											</div>
										</div>
										<div className="col-lg-4 col-md-6">
											<div className="card-servies-2 rounded-2 h-100 hover-up">
										...
										<div className="col-lg-4 col-md-6">
											<div className="card-servies-2 rounded-2 h-100 hover-up">
												...
												<p className="fs-7 text-300 fw-regular"> Integrating AI-driven solutions in backend systems to boost applications for efficiency, automation, and enhanced user experience</p>
											</div>
										</div>
									</div>
									<div className="text-center pt-60">
										<p className="text-300">
											I'm excited to take on <span className="text-dark">new projects</span> and collaborate. <br />
											Let's chat about your ideas. <Link href="https://www.linkedin.com/in/parwar-ofosu-william-a66786203/" className="text-primary-2">Reach out!</Link>
										</p>
									</div>
								</div>
							</div>
